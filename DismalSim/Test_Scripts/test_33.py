...
The script constructs a graph in which NIR takes on a random value
...
the time period 1980- 1989. This graph includes feedback from EX and IM
to FX.
"""
...
deltacalc.output_spreadsheet("test_33_data", output)