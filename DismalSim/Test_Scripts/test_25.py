...
The script constructs a graph that only involves RIR and not NIR
...
script involves the correct transmittances to FX, including feedback
from EX and IM.
"""
...
aGraph.add_edge("PL", "RIR", "pa_lin", [-0.0379])
...
deltacalc.output_spreadsheet("test_25_data", output)