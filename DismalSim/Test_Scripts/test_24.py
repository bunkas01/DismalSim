...
involves the correct transmittance from NIR to FX and has eliminated
the feedback from EX and IM to FX.
"""
...
aGraph + digraph.Vertex("FX", 71.41, deltaInherent=8.73)
...
aGraph.add_edge("NIR", "FX", "aa_lin", [10.9])
...
deltacalc.output_spreadsheet("test_24_data", output)