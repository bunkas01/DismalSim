...
in order to test the fundamental robustness of the model. This script
sets the exchange rate to change by a random amount and removes the
edges that would otherwise lead to the exchange rate.
"""
...
aGraph + digraph.Vertex("FX", 71.41, randomDeltaFlag=True, randomInfo=(0, 12))
...
initDelta = {"G": 114.4, "T": 50.4, "C": 134.6, "YD": 144, "IM": -6.2,
             "Y": 194.4, "EX": 43, "PL": 5.5, "I": -49.2, "M2": 118.6,
             "NIR": -2.41, "RIR": -1.21}

output = deltacalc.gc_multicount_delta(aGraph, 8, initDelta)
deltacalc.output_spreadsheet("test_17_data", output)