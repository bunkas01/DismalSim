...
script involves the correct transmittance from RIR to FX and eliminates
the feedback from IM and EX to FX.
"""
...
aGraph + digraph.Vertex("FX", 71.41, deltaInherent=8.95)
...
aGraph.add_edge("RIR", "FX", "aa_lin", [16.7])
...
deltacalc.output_spreadsheet("test_26_data", output)