...
between 6.5 and 16.5, and runs it through the time period of 1990-1999;
the regressions used to calculate edge relationships were performed on
the time period 1980-1989. This graph does not include feedback from EX
and IM to FX.
"""
...
aGraph + digraph.Vertex("NIR", 8.1, randomValFlag=True, randomInfo=(6.5, 16.5))
...
deltacalc.output_spreadsheet("test_34_data", output)