...
"""Multiple Linear Regressions 1955-1989, G Causes T.

A test script using the transmittances gained from multiple linear
regressions on the period 1955-1989, assuming that government spending
determines taxes.
"""

aGraph = digraph.DiGraph()
aGraph + digraph.Vertex("G", 1920.2, deltaInherent=45.8)
aGraph + digraph.Vertex("T", 1712.9, deltaInherent=1.7)
...
aGraph.add_edge("G", "T", "aa_lin", [0.91])
...
deltacalc.output_spreadsheet("test_06_data", output)