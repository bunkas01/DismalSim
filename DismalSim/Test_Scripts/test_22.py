...
The script constructs a graph in which NIR takes on random values
...
in order to test the fundamental robustness of the model. This test
script involves the correct transmittances to FX.
"""
...
aGraph + digraph.Vertex("NIR", 8.1, randomValFlag=True, randomInfo=(3, 8))
...
deltacalc.output_spreadsheet("test_22_data", output)