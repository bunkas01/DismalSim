...
the Imports and Exports vertices to the Foreign-Exchange Vertex. The
regressions used to calculate edge relationships were performed over
...
deltacalc.output_spreadsheet("test_10_data", output)