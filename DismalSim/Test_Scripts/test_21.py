...
edge relationships were performed on the same time period, in order to
test the fundamental robustness of the model. This test script involves
the correct transmittances to FX.
"""
...
deltacalc.output_spreadsheet("test_21_data", output)