...
The script constructs a graph with only NIR and not RIR and runs it
...
aGraph + digraph.Vertex("G", 1920.2, deltaInherent=-16.7)
aGraph + digraph.Vertex("T", 1712.9, deltaInherent=3.02)
aGraph + digraph.Vertex("YD", 4266.7)
aGraph + digraph.Vertex("C", 3825.6, deltaInherent=7.20)
...
aGraph + digraph.Vertex("I", 993.5, deltaInherent=-79.04)
aGraph + digraph.Vertex("FX", 71.41, deltaInherent=3.31)
...
aGraph.add_edge("YD", "C", "aa_lin", [0.943])
aGraph.add_edge("NIR", "C", "aa_lin", [-3.41])
...
aGraph.add_edge("NIR", "I", "aa_lin", [-26.8])
aGraph.add_edge("Y", "I", "aa_lin", [0.344])
aGraph.add_edge("NIR", "FX", "aa_lin", [2.98])
aGraph.add_edge("EX", "FX", "aa_lin",[-0.152])
aGraph.add_edge("IM", "FX", "aa_lin", [0.157])
...
deltacalc.output_spreadsheet("test_35_data", output)