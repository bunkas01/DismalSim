...
Furthermore, Y is exogenized in this script. The regressions used to
calculate edge relationships were performed over the same time period,
in order to test the fundamental robustness of the model.
"""
...
deltacalc.output_spreadsheet("test_15_data", output)