...
graph does not include feedback from EX and IM to FX.
"""
...
aGraph + digraph.Vertex("I", 993.5, deltaInherent=-79.0)
aGraph + digraph.Vertex("FX", 71.41, deltaInherent=6.44)
...
aGraph.add_edge("NIR", "FX", "aa_lin", [3.11])
...
deltacalc.output_spreadsheet("test_36_data", output)